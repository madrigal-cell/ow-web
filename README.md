...
- [x] Paso 6 · Lighthouse móvil sobre https://nueva.owmakers.com (12 sep 2026): rendimiento 98-100, accesibilidad 100, buenas prácticas 100, SEO 100 en Home, Trabajos, caso, Servicios, servicio, Para agencias, Nosotros y Contacto. Ajustes: gris de etiquetas y naranja de texto pequeño con contraste AA (`--color-label`, `--color-accent-ink`), nombre accesible del selector de idioma y jerarquía de títulos en Trabajos.
